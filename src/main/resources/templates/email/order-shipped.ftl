  ...
  <body style="font-size: 16px;">
    ...
    <article>
      <h1 style="font-family: 'Exo 2', sans-serif;
		  ...
		  vertical-align: bottom;">Order Shipped</h1>
      
      <p>Your purchase from <span style="font-weight: bold; color: #555568;">Black Plum Apparel</span> is on its way!</p>
      
      <#if trackingUrl??>
      	You can track your order <a href=${trackingUrl}>here</a>.
      </#if>
